...
part of 'feed_remote_data_source.dart';
...
class _FeedRemoteDataSource implements FeedRemoteDataSource {
  ...
  Future<List<FeedModel>> getPosts(
    ...
    final _options = _setStreamType<List<FeedModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<FeedModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => FeedModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
